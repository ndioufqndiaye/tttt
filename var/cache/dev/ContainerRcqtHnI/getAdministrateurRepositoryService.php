...
// Returns the private 'App\Repository\AdministrateurRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/AdministrateurRepository.php';

return $this->privates['App\\Repository\\AdministrateurRepository'] = new \App\Repository\AdministrateurRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
