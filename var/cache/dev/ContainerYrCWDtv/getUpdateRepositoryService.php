...
// Returns the private 'App\Repository\UpdateRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UpdateRepository.php';

return $this->privates['App\\Repository\\UpdateRepository'] = new \App\Repository\UpdateRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
