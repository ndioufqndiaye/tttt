...
// Returns the private 'App\Repository\AuthentificationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/AuthentificationRepository.php';

return $this->privates['App\\Repository\\AuthentificationRepository'] = new \App\Repository\AuthentificationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
