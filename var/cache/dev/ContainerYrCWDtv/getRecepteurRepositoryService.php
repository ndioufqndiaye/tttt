...
// Returns the private 'App\Repository\RecepteurRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/RecepteurRepository.php';

return $this->privates['App\\Repository\\RecepteurRepository'] = new \App\Repository\RecepteurRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
