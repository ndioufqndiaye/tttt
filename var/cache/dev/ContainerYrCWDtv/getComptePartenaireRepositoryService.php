...
// Returns the private 'App\Repository\ComptePartenaireRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ComptePartenaireRepository.php';

return $this->privates['App\\Repository\\ComptePartenaireRepository'] = new \App\Repository\ComptePartenaireRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
